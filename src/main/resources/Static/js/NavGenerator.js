...
const submitNewUserButton = document.getElementsByClassName("submitButtonSquare");
if(Array.isArray(submitNewUserButton) && submitNewUserButton.length) {
    submitNewUserButton.addEventListener("click", function() {
        localStorage.setItem("loggedOn","true");
        console.log("firing!");
        console.log("Logged On: "+ localStorage.getItem("loggedOn"));
    });
}
...
logOff.setAttribute("th:if", "${loggedIn == true}");
logOff.setAttribute("class", "logOff");
logOff.innerText = "Log Out";
barRightBottom.appendChild(logOff);
//
// PROFILE PAGE BUTTON
const profileButton = document.createElement("a");
// profileButton.setAttribute("th:if", "${loggedIn == true}");
profileButton.setAttribute("class", "profileButton");
profileButton.setAttribute("href", "/users/Jenkins/21");
profileButton.innerText = "Profile";
barRightBottom.appendChild(profileButton);

// const userProfile = document.createElement("a");
// userProfile.setAttribute("class", "horizontalLinkBox");
// userProfile.setAttribute("href", "/users/{lastName}");
// footBar.appendChild(userProfile);
// const profileWording = document.createElement("div");
// profileWording.setAttribute("class", "horizontalLink");
// profileWording.innerText = "View Profile";
// userProfile.appendChild(profileWording);
